 ...
 */
// Audio BPM detection worker. Receives a Float32Array (transferred ArrayBuffer) of a
// single audio channel, posts "OK" once ready, then posts progress strings and finally
// a beat_zone array (index 0 carries .tempo_final, the detected BPM).
